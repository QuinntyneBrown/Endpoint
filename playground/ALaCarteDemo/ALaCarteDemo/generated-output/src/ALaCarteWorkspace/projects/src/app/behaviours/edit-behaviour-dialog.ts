...
export class EditBehaviourDialogService {
  ...
  public attachOverlayContainer(overlayRef, overlayRefWrapper) {
    ...
    const overlayPortal = new ComponentPortal(EditBehaviourDialog, null, injector);
    const overlayPortalRef: ComponentRef<EditBehaviourDialog> = overlayRef.attach(overlayPortal);
