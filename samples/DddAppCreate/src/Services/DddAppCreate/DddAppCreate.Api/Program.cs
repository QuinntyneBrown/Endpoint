...
try
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "DddAppCreate");
    ...
    {
        var context = scope.ServiceProvider.GetRequiredService<DddAppCreateDbContext>();
        ...
        {
            context.Database.ExecuteSql($"DROP SCHEMA [DddAppCreate]");

            context.Database.ExecuteSql($"DELETE from __EFMigrationsHistory where MigrationId like '%_DddAppCreate_%';");
        }
