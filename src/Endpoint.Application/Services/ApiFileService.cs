...
namespace Endpoint.Application.Services
{
    public class ApiFileService : BaseFileService, IApiFileService
    {
        ...
        public void Build(Settings settings)
        {
            ...
            {
                new ClassBuilder($"{((Token)resource).PascalCase}Controller", new Endpoint.SharedKernal.Services.Context(), _fileSystem)
        ...
        private void _buildProgram(Settings settings)
        {
