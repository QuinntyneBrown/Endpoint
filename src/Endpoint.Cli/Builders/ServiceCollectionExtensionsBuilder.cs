...
namespace Endpoint.Cli.Builders
{
    public class ServiceCollectionExtensionsBuilder
    {
        ...
        public void Build()
        {
            ...
            _fileSystem.WriteAllLines($@"{_directory}/{_namingConventionConverter.Convert(NamingConvention.PascalCase,nameof(ServiceCollectionExtensionsBuilder))}.cs", contents);
        }
    }
}
