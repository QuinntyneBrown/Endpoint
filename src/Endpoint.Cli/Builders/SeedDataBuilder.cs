...
namespace Endpoint.Cli.Builders
{
    public class SeedDataBuilder
    {
        ...
        public SeedDataBuilder SetDirectory(string directory)
        {
            _directory = directory;
            return this;
        }

        public SeedDataBuilder SetRootNamespace(string rootNamespace)
        {
        ...
        public void Build()
        {
            ...
            _fileSystem.WriteAllLines($@"{_directory}/{_namingConventionConverter.Convert(NamingConvention.PascalCase,nameof(SeedDataBuilder))}.cs", contents);
        }
    }
}
