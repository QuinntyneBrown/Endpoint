...
public class ProducesResponseTypeAttributeSyntaxGenerationStrategy : SyntaxGenerationStrategyBase<ProducesResponseTypeAttributeModel>
{
    ...
    public override string Create(ISyntaxGenerationStrategyFactory syntaxGenerationStrategyFactory, ProducesResponseTypeAttributeModel model, dynamic context = null)
    {
