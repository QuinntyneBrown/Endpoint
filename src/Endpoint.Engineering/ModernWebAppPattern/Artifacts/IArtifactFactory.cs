...
public interface IArtifactFactory
{
    ...
    Task<IEnumerable<FileModel>> AggregateCreateAsync(Endpoint.Engineering.DomainDrivenDesign.IDataContext context, AggregateModel aggregate, string directory, CancellationToken cancellationToken);
