...
using Endpoint.Engineering.ModernWebAppPattern.Extensions;
...
namespace Endpoint.Engineering.ModernWebAppPattern.Artifacts;
...
public class ArtifactFactory : IArtifactFactory
{
    ...
    public async Task<IEnumerable<FileModel>> AggregateCreateAsync(Endpoint.Engineering.DomainDrivenDesign.IDataContext context, AggregateModel aggregate, string directory, CancellationToken cancellationToken)
    {
