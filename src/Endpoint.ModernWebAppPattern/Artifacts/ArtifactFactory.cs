...
using Endpoint.ModernWebAppPattern.Extensions;
...
using AggregateModel = Endpoint.DomainDrivenDesign.Models.AggregateModel;
...
public class ArtifactFactory : IArtifactFactory
{
    ...
    public async Task<IEnumerable<FileModel>> AggregateCreateAsync(Endpoint.DomainDrivenDesign.IDataContext context, AggregateModel aggregate, string directory, CancellationToken cancellationToken)
    {
