...
Endpoint.ModernWebAppPattern provides templates and generators for creating modern web applications following clean architecture principles. It integrates DDD patterns with ASP.NET Core best practices.
...
- **Endpoint.DomainDrivenDesign** - DDD patterns
